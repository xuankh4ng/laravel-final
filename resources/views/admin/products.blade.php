            ...
            @forelse ($products as $product)
                <div
                    ...
                    <div class="relative h-52 bg-ef-bg-2 overflow-hidden">
                        <img src="https://placehold.co/400x400/F2EFDF/5C6A72?text={{ $product->name }}"
                    ...
                    <div class="px-5 pb-5 flex gap-2">
                        ...
                        <button
                            class="cursor-pointer flex-1 flex items-center justify-center p-2 text-ef-red bg-ef-bg-red/20 border border-ef-red/10 rounded-lg hover:bg-ef-red hover:text-white transition-all">
